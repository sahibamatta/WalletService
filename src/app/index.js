...
import { LogoutSeller } from "./components/login-logout/logout/logoutSeller";
...
import { AmountTransferSeller } from "./components/wallet/amount-transfer-seller/amountTransferSeller";
    ...
    render() {
        return (
            ...
            <Router history={browserHistory}>
                ...
                <Route path="AmountTransferSellerReport" components={AmountTransferSeller} onEnter={this.requireAuthSeller} />
                <Route path="LogoutSeller" components={LogoutSeller} onEnter={this.requireAuthSeller} />
            </Router>
        );
    }
}
